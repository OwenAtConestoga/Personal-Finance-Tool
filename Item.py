...
class Item:
   counter = 0
   # Constructor of the Item class, initializes the item with its id, name, revenue, and quantity
   ...
   # Static method to find the byte offset of a specific line number in the CSV file
   @staticmethod
   ...
   # Static method to add a new item to the CSV file
   @staticmethod
   ...
   # Static method to search for an item in the CSV file
   @staticmethod
   ...
   # Static method to delete an item from the CSV file
   @staticmethod
   ...
   # Static method to calculate the total revenue generated by all items
   @staticmethod 
   def item_revenue():
   ...
   # Method to get the quantity of a particular item
